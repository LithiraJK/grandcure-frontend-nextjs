      ...
      <section className="space-y-5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 rounded-2xl border border-[#d8e4ee] bg-white px-4 py-3 text-xs text-secondary shadow-soft">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            {searchQuery.trim() ? (
              <span className="rounded-full bg-[#edf4fa] px-2.5 py-1 font-semibold text-primary">
            ...
            >
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-2xl bg-[#f4f9fd] p-4">
                  ...
                  <p className="mt-2 text-xs text-secondary">
                    {selectedAssignment.distanceMiles} miles away
                  </p>
                </div>
              </div>
              ...
              <div className="mt-3 rounded-2xl bg-[#f8fbfe] p-4">
                ...
                <p className="mt-1 text-sm text-zinc-800">
                  {selectedAssignment.note || "No additional notes."}
                </p>
              </div>
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between gap-2 text-sm">
                ...
                <span className="text-base font-extrabold text-zinc-900">
                  {formatFee(selectedAssignment.fee)}
                </span>
              </div>
            </div>
          </div>
